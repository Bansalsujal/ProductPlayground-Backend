...
import { router as authRouter, verifyToken } from './routes/auth.js';
...
// Always ensure 127.0.0.1:5000 is included
...
app.get('/api/user/me', async (req, res) => {
  try {
    ...
    res.json({
      ...
      career_stage: userProfile?.career_stage || 'junior',
...
app.put('/api/user/update', async (req, res) => {
  try {
    ...
    res.json({
      ...
      career_stage: profile.career_stage || 'junior',
...
// Only start the server when not in test mode (allows production deployment)
